...
showCategory = () => {
    document.getElementById('category-container').innerHTML = `<button onclick="defaultIndiaNews()" class="btn btn-success btn-sm mx-1 my-1">All</button>`;
    for (category in categories) {
        document.getElementById('category-container').innerHTML += `<button onclick="indianCategoryNews('${category}')" class="btn btn-success btn-sm mx-1 my-1">${categories[category]}</button>`;
    }
}
        ...
        (data) => {
            ...
            <div class="row no-gutters">
                ...
                <div class="card-body">
                            ...
                            <a role="button" class="btn btn-primary btn-sm" href="${data.url}" rel="noopener" target="_blank">View full coverage</a>
                        </div>
                </div>
            </div>
        </div>`;
